...
async def help_command(message: types.Message):
	...
	if is_admin(message.from_user.id):
		...
		/stats - Статистика по пользователям(⚠️В разработке!!!)
		/broadcast - Рассылка сообщения всем пользователям (⚠️В разработке!!!)
	...
	/profile - Ваш прогресс и статистика (⚠️В разработке!!!)
	...
	/clear_context - Очистить память бота(Внимание!!!, нельзя откатить)
	
	<b>📝 Работа с дневником:</b>
	/day - Записать сегодняшние мысли (⚠️В разработке!!!)
	/reset_day - Сбросить текущий день (⚠️В разработке!!!)
	
	<b>🎮 Геймификация:</b>
	/me - Ваш текущий уровень и XP
	/quests - Активные задания (⚠️В разработке!!!)
